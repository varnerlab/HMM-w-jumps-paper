...
engine-raw median over an external long-run growth prior, reported
quantitatively as $\sim\!22$~percentage points in the next
paragraph, is therefore not a structural artifact of the iid
sampling at the level of the second-order formula. It is the
...
location-shift correction derived below treats this composite
shortfall as a single empirical drag $b$ to be absorbed and is
agnostic to its decomposition.
