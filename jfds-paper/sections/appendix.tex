...
$11.5\%/\mathrm{yr}$, about $22$ percentage points below the
...
outcome of $11.5\%/\mathrm{yr}$ was at the $63$rd percentile of the
corrected ensemble.
...
median Sharpe ratio by less than $0.01$ across the sweep, so
...
by less than one percentage point across $N \in \{60, \ldots, 200\}$.
At $N = 30$ both models lost approximately $5$ percentage
