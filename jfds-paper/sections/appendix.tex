...
The four distributional metrics reported in Section~\ref{sec:results-hmm}
...
The hybrid hidden Markov simulator (Section~\ref{sec:method-hmm-jump})
proceeded as follows. Given fitted parameters
