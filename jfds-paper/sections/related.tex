...
on the empirical regularities that drive risk and pricing. \citet{mandelbrot1963}
showed returns have heavier tails than the Gaussian admits;
\citet{famaEMH1970} reviewed evidence that raw returns have
near-zero autocorrelation; and \citet{schwert1989} documented
persistence in monthly absolute residuals, later codified by
\citet{cont2001} as volatility clustering. The autoregressive
...
latent discrete chain, following the two-state regime-switching
formulation of \citet{hamilton1989}, later applied to volatility
...
generated for. \citet{boothFama1992} described one
