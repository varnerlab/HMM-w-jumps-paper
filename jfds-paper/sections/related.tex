...
a factor model.
The relevant comparison is with methods fitted directly to regression
residuals: those methods remove the market component before fitting,
whereas reuse adjusts an existing full-return draw during composition.
Neither approach specifies cross-asset residual dependence unless that
dependence is modeled separately.
