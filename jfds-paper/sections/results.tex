...
The same ordering largely persisted when the fitted models and SIM
parameters were frozen and evaluated against $416$ complete asset
histories from $2025$ (Table~\ref{tab:oos_composition}). The hybrid
method reached an $84.1\%$ mean cross-ticker KS pass rate and a
$76.4\%$ AD pass rate, compared with $78.8\%$ and $67.1\%$ for naive
composition. Its median composed-to-observed variance ratio was
$0.97$, whereas naive composition remained inflated at $1.29$.
JumpHMM-on-residuals retained the strongest marginal fit, with
$86.2\%$ KS and $80.1\%$ AD pass rates and a median $W_1$ of $0.708$,
compared with $0.741$ for the hybrid. Matched-length training blocks
produced lower non-rejection rates for every method, showing that the
higher $2025$ pass rates did not arise solely from comparing samples
of $249$ rather than $2{,}766$ observations. Figure~\ref{fig:oos_composition}
shows that these averages nevertheless conceal substantial cross-ticker
heterogeneity. Most ticker-level pass rates were concentrated near the
upper end of the range, but every method retained a lower tail of weak
fits. For the hybrid method, many tickers improved relative to their
matched-length training blocks, while a subset deteriorated substantially
out of sample.
...
$6.13\%$ and $6.07\%$, respectively, against the $5\%$ nominal rate.
At $\alpha=0.99$, their rates were $1.71\%$ and $1.67\%$, against the
$1\%$ nominal rate. Naive composition was closest at the $99\%$
level ($1.24\%$), while Gaussian SIM had the largest exceedance rate
