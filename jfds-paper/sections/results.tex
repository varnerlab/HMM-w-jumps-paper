...
the ticker's real growth-rate history: SIM recovery via OLS on the
...
index on the upper $5\%$ order statistics of $|g|$ (definitions in
Online Appendix~\ref{sec:supp-validation}); and variance
...
$\beta$ (Fig.~\ref{fig:preservation}). The variance-ratio panel made the mechanism explicit: the naive
