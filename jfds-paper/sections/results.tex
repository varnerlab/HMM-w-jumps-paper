...
branch selector assigned the $R^2$-preserving branch as intended,
...
crowding out the marginal. The clipping branch is therefore not a degradation under stress
but a mechanism that keeps the composed marginal near the generator
target as the market loading inflates.
