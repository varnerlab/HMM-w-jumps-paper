...
of $249$ rather than $2{,}766$ observations. The ticker-level
distributions remained heterogeneous, however, and a subset of
assets deteriorated substantially out of sample
(Fig.~\ref{fig:oos_composition}).
...
\begin{figure}[tbp]
  \centering
  \includegraphics[width=\textwidth]{figs/Fig-OoS-Composition.pdf}
