...
(Supplementary Fig.~\ref{fig:tails}). Gaussian SIM had the lowest median $R^2$ error
...
(Supplementary Table~\ref{tab:allocator_decomp}). This comparison was consistent
