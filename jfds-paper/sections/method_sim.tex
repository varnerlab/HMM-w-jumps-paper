...
\subsubsection{Preservation criteria}
...
\subsubsection{Variance correction}
...
\subsubsection{Beta clipping with an idiosyncratic floor}
...
\subsubsection{$R^2$-preserving branch for tracker assets}
\label{sec:method-r2}
...
\subsubsection{Branch selection, algorithm, and properties}
