...
All full-return constructions in our comparison first removed the
realized path mean. We defined the centered generator path as:
\begin{equation}
...
\begin{equation}
  ...
  \label{eq:scale}
\end{equation}
For clarity, we defined the \emph{market loading ratio} as:
\begin{equation}
...
variance. QQQ and SPYG also have high $R^2$ against SPY. Applying the
