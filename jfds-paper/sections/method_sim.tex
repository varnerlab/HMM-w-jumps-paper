...
from the released \texttt{JumpHMM.jl}
library\footnote{\url{https://github.com/varnerlab/JumpHMM.jl}}, fit
to the asset's own full growth-rate history (not to residuals after
market detrending) using the default EM tolerance and
