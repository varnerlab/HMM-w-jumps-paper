...
The main difficulty is choosing $\eps_i$. A standard SIM uses
...
residual receives the remaining fraction, so $s_i^2=1-\rho_i$.

This correction is impossible when $\rho_i\geq 1$ because the market
...
can preserve total variance while changing the fitted $R^2$.

We therefore used a separate branch when the real-data value
