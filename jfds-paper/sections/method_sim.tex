...
per-asset residual that the construction must specify. Two
...
The naive approach, a \emph{Gaussian-residual composition},
...
% Implementation??
% When $\beta_i$ is clipped, both $\beta_i$ and $\beta_i^{\eff}$ are
...
the market, not its marginal. SPY against itself has $\beta = 1$,
$R^2 = 1$, and zero residual variance exactly; QQQ against SPY has
$R^2 \approx 0.84$, and SPYG against SPY has $R^2 \approx 0.86$. A
