...
realized path mean. We defined the centered generator path as follows:
\begin{equation}
...
(Supplementary Fig.~\ref{fig:r2_distribution}). On this branch, we computed the
...
\caption{\textbf{HMM-WJ and SIM composition hyperparameters.} Values
    ...
    cross-asset validation are given in Supplementary Table~\ref{tab:cross_asset}.}
