...
$\sigma_{\gen,i}^2=\Var(\tg_i)$, which we call the \emph{generator
...
variances.
For long paths, OLS on the composed series recovers the intercept
$\alpha_i$ and effective market loading $\beta_i^{\eff}$. The
