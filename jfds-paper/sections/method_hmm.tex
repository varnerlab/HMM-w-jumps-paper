...
$\nu$ degrees of freedom, and $\mu_k, \sigma_k$ are the state-conditional
location and scale parameters, estimated as the sample mean and sample
standard deviation of the in-sample observations assigned to state $k$
under the Laplace-quantile partition. The value $\nu = 5$ was
...
gain/loss asymmetry (Figure~\ref{fig:model_architecture}). The empirical
...
We calibrated the two jump model hyperparameters,
...
of those classical models, using a multi-objective grid search that
minimized the discrepancy between historical and
