...
(Table~\ref{tab:descriptive_stats}), we drop it. The realized
annualized compound
...
$\beta$ distribution spans $[0.03, 1.79]$ (Fig.~\ref{fig:branch_map}).
...
Table~\ref{tab:supp-generator-quantities} collects these values
...
observations (Table~\ref{tab:supp-generator-quantities}). Every within-state mean $\mu_k$ and standard deviation
...
between $0.0058$ and $0.017$ (Table~\ref{tab:supp-generator-quantities}). The
...
$0.0631~\mathrm{yr}^{-1}$ (Table~\ref{tab:supp-generator-quantities}).
...
(Table~\ref{tab:supp-generator-quantities}), where
...
(Table~\ref{tab:supp-generator-quantities}),
...
(Table~\ref{tab:supp-generator-quantities}). The emission choice enters
...
(Tables~\ref{tab:supp-generator-quantities}
...
matrix (Table~\ref{tab:supp-generator-quantities}), $|\theta_2| = 0.253$, and $|\theta_2|^\tau$ falls below
...
$0.0088$ (Table~\ref{tab:supp-generator-quantities}). The product $\epsilon \lambda$ is the quantity that sets
...
Table~\ref{tab:supp-generator-quantities}), matching the $\sim\!24\%$
...
(Table~\ref{tab:supp-generator-quantities}), slightly higher through the
...
(Table~\ref{tab:supp-generator-quantities}). The
...
$0.13$ (Table~\ref{tab:supp-generator-quantities}).
Table~\ref{tab:supp-acf-prediction} compares
...
at lag $1$; Table~\ref{tab:supp-acf-prediction}) because the free-phase geometric component of
...
with no jumps (Table~\ref{tab:supp-generator-quantities}). Forced steps inflate the variance, by about $17\%$ at
...
(Table~\ref{tab:descriptive_stats}). The Student-$t$
...
(Table~\ref{tab:supp-kurt-composition}). For a low-loading asset
...
matched the rare-event setting (Table~\ref{tab:jump_ablation_episodes}):
$247$ of
