...
Fig.~\ref{fig:model_internals} shows the fitted HMM-WJ components for
...
(Table~\ref{tab:emission_hsmm}): an HSMM-style baseline adapted from
Bulla and Bulla \cite{bullaBulla2006} ($K = 8$ states,
