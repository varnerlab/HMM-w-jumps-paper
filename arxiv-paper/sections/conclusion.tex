...
To reuse full-return generators in a factor model without double
counting their location or variance, we developed a variance-corrected
single-index composition method. Centering first
...
that retained heavy tails and temporal structure. We used a hidden
Markov marginal model with Laplace-quantile states, Student-$t$ emissions, and direct
