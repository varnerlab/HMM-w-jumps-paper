...
baseline adapted from Bulla and Bulla~\cite{bullaBulla2006} is given in
...
rather than using iterative expectation-maximization, which avoided
...
Table~\ref{tab:hyperparams} gives all four jump settings. Each
