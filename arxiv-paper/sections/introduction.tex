...
of SPY data, HMM-WJ reduced absolute-return autocorrelation error from $0.059$
to $0.053$ relative to HMM-NJ while retaining a $98.3\%$ in-sample
Kolmogorov--Smirnov pass rate. GARCH achieved a lower autocorrelation error of
$0.031$ but did not match the return distribution, so HMM-WJ served as a
...
pass rate from $83.5\%$ to $87.0\%$ across $416$ complete asset histories from
$2025$ and reduced the median ratio of synthetic to observed variance from
$1.29$ to $0.97$. Independent residual generation did not reproduce residual
