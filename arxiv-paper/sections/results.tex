...
(Table~\ref{tab:sensitivity_n}). At $N = 350$, some states were never
...
(Table~\ref{tab:descriptive_stats}; Online
...
(Table~\ref{tab:aggregate}; Fig.~\ref{fig:tails}). Gaussian SIM had the
...
$R^2$ (Table~\ref{tab:tracker_grid}).
