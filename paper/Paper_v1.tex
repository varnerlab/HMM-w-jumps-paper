...
\begin{keyword}
Synthetic Data Quality \sep Time Series Generation \sep Hidden Markov Model \sep Jump-Diffusion \sep Volatility Clustering \sep Regime-Switching \sep Stylized Facts \sep Distributional Fidelity
\end{keyword}
