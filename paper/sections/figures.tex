...
\begin{figure}[htpb]
    ...
    $\geq\!98\%$, confirming that the Laplace-mixture emission adequately captures the observed
    heavy tails.  HMM-WJ generalises robustly out-of-sample (OoS KS pass rate 94\%), while
