...
The four algorithms below detail the complete computational pipeline: model construction (Algorithm~\ref{alg:build}), jump-diffusion simulation (Algorithm~\ref{alg:sim}), state decoding and continuous rate reconstruction (Algorithm~\ref{alg:decode}), and hyperparameter grid search (Algorithm~\ref{alg:grid_search}).
